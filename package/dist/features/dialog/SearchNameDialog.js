...
var _searchNameDialogSlice = require('./searchNameDialogSlice');
...
var SearchNameDialog = function SearchNameDialog(_ref) {
  ...
  var handleSearch = function handleSearch(event) {
    ...
    var openings = _Opening2.default.byName(event.target.elements.name.value);
  ...
  return _react2.default.createElement(
    _material.Dialog,
    { open: state.searchNameDialog.open, maxWidth: 'sm', fullWidth: true },
...
exports.default = SearchNameDialog;