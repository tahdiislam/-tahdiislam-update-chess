...
var EventsStatsDialog = function EventsStatsDialog(_ref) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 4;
              return fetch(props.api.prot + '://' + props.api.host + ':' + props.api.port + '/api/stats/event', {
                method: 'POST',
                body: JSON.stringify((_JSON$stringify = {}, _defineProperty(_JSON$stringify, event.target.elements.Event.name, event.target.elements.Event.value), _defineProperty(_JSON$stringify, event.target.elements.Result.name, event.target.elements.Result.value), _JSON$stringify))
              }).then(function (res) {
  ...
  return _react2.default.createElement(
    _material.Dialog,
    { open: state.eventsStatsDialog.open, maxWidth: 'md', fullWidth: true },
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(_Autocomplete2.default, {
              id: 'Event',
              options: state.eventsStatsDialog.autocomplete.events.map(function (option) {
                return option.Event;
              }),
              filterOptions: filterOptions,
              renderInput: function renderInput(params) {
                return _react2.default.createElement(_material.TextField, _extends({ required: true }, params, { label: 'Event', variant: 'filled', name: 'Event' }));
              }
            })
          ),
          _react2.default.createElement(
...
exports.default = EventsStatsDialog;