...
var OfferDrawDialog = function OfferDrawDialog() {
  var state = (0, _reactRedux.useSelector)(function (state) {
    return state;
  });
  var dispatch = (0, _reactRedux.useDispatch)();

  var handleDrawOffer = function handleDrawOffer(event) {
    event.preventDefault();
    _WsAction2.default.draw(state, _Wording2.default.verb.PROPOSE.toLowerCase());
  ...
  return _react2.default.createElement(
    _material.Dialog,
    { open: state.offerDrawDialog.open, maxWidth: 'xs', fullWidth: true },
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            { onClick: function onClick() {
                return dispatch(offerDrawDialog.close());
              } },
            'Cancel'
          )
        )
...
exports.default = OfferDrawDialog;