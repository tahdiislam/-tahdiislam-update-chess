...
var CheckmateSkillsDialog = function CheckmateSkillsDialog() {
  var state = (0, _reactRedux.useSelector)(function (state) {
    return state;
  });
  var dispatch = (0, _reactRedux.useDispatch)();

  var checkmateTypes = ['QR,R', 'Q', 'R', 'BB', 'BN'];
  ...
  var handleCreateGame = function handleCreateGame() {
    ...
    var items = fields.items === 'rand' ? checkmateTypes[Math.floor(Math.random() * checkmateTypes.length)] : fields.items;
  ...
  return React.createElement(
    _material.Dialog,
    { open: state.checkmateSkillsDialog.open, maxWidth: 'xs', fullWidth: true },
    React.createElement(
      ...
      React.createElement(
        ...
        { onClick: function onClick() {
            return dispatch(checkmateSkillsDialog.close());
          } },
...
exports.default = CheckmateSkillsDialog;